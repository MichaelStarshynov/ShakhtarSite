window.news = [
  {
    ...
    text: '<h3>AZ gets points to Alkmaar</h3><p>Starting XI: Owuso-Oduro, Chavez, Penetra, Goes, de Wit, Smit, Koopmeiners, Mijnans (C), Jensen, parrott and Patati.</p><br><h4>First Half</h4><p>Frst half began with goal on 17 minute from <strong>Sven Mijnans</strong> after pass of Jensen. The first half was dominated by AZ.</p><br><h4>Second Half</h4><p>In the second half <strong>Isak Jensen</strong> scored a goal, after the assist of Kees Smit. In the 90 minute <strong>Ibrahim Sadiq</strong> also scored, the assist was given by Mees De Wit. </p><br><img class="news-img" src="https://images.ad.nl/OWUwNzY0YWM3N2JmODZjOTIyNzQvZGlvLzI2NjYwMDcwMS9maWxsLzEyMDAvNjMw/isak-jensen"><p>The man of the match by our opinion is Isak Jensen, thas scored a goal and gave a assist.</p><br></h4>Highlights of the match:</h4><ul><li class="goalAZ">⚽ 17 minute - Sven Mijnans (Isak Jensen)</li><li class="goalAZ">⚽ 58 minute - Isak Jensen (Kees Smit)</li><li class="goalAZ">⚽ 90 minute - Ibrahim Sadiq (Mees de Wit)</li></ul><br><p>🔜 Next match AZ will play on 18 december against Jagiellonia in Alkmaar.</p>',
  },
  {
    id: 5,
    datum: "7-12-2025",
    title: "AZ Alkmaar 2-2 Go Ahead Eagles",
    image: "https://i.postimg.cc/dVBW4VSz/049ef60f-ae68-4710-8851-dfd724cd1f59.jpg",
    text: '<h3>AZ couldnt take revenge on Go Ahead Eagles<h3><p>Starting XI: Owuso-Oduo, Chavez, Penetra, Goes, de Wit, Koopmeiners, Smit, Mijnans (C), Parrott, Patati and Jensen.</p><br><h4>First Half</h4><p>The First Half began with quick goal of Meulensteen for Go Ahead Eagles. 21 minute after <strong>Troy Parrott</strong> scored with head after the pass of de Wit. 9 minutes after goal of Troy there as a own goal of Delij.</p><br><h4>Second Half</h4><p>Second half was controled by AZ, but in the 80 minute Meulensteen scored and make draw in Alkmaar.</p><img class="news-img" src="https://staticcdn.fcupdate.nl/images/cf/image/upload//pKUv5NKDPINXWGM3LP3TNzX7aG67AOHY//q=90,g=auto,fit=contain,compression=fast,w=1560,h=920"><p>Man of the match by our opinion is Kees Smit, who was one of the most creative players on the field.</p><br><h4>Highlights of the match:</h4><ul><li>⚽ 10 minute - Meulensteen (Go Ahead Eagles)</li><li class="goalAZ">⚽ 31 minute - Troy Parrott (Mees De Wit)</li><li class="goalAZ">⚽ 40 minute - Delij (Own Goal)</li><li>⚽ 80 minute - Meulensteen (Kramer)</li></ul><br><p>🔜 Next match AZ will play on 11 december against Drita in Conference League.</p>',
  },
  {
    id: 4,
    datum: "4-12-2025",
