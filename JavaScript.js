...
const pages = {
  ...
  Матчі: { 
    title: `Матчі`, 
    text:  `<p>Место в УПЛ: 1 місце</p><p>Місце в Лізі Конференцій: не почалося</p><p>Місце в кубку України: 1/8</p>`
  ...
  Магазин: {
    ...
    text: `Атрибутику Шахтаря можно купити <a href="https://shop.shakhtar.com/ru/" target="_blank">тут</a>.<img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRsxQjeSy2AG37trL2PTyXWF-4GIMO7mvkXzA&s" style="max-width:300px;">`
  },
  Телеграм: {
